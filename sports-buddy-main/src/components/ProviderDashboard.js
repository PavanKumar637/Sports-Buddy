        ...
        return (
            <div className="min-vh-100 d-flex align-items-center justify-content-center bg-light">
                <div className="text-center">
                    <h3 className="text-danger mb-3">Post Not Found</h3>
                    <button 
        ...
        <div className="min-vh-100 bg-light">
            <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
                <div className="container">
                    <span className="navbar-brand">Welcome, {profile?.userName || username || 'User'}</span>
                    <button 
                        ...
                        <div className="card shadow-sm border-0 mb-4">
                            <div className="card-header bg-primary text-white py-3">
                                <h5 className="card-title mb-0">
                                    <i className="fas fa-user-circle me-2"></i>Sport Information
                                </h5>
                            </div>
                                    ...
                                    <div className="col-md-6 mb-3">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="mb-0 fw-bold">{profile?.sport || 'Not Provided'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-3">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="mb-0 fw-bold">{profile?.date ? new Date(profile.date).toLocaleString() : 'Not Provided'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-3">
